...
J3DIMatrix4.prototype.lookat = function(eyex, eyey, eyez, centerx, centery, centerz, upx, upy, upz)
{
    ...
    if (Math.abs(z0) < GLMAT_EPSILON &&
        Math.abs(z1) < GLMAT_EPSILON &&
        Math.abs(z2) < GLMAT_EPSILON) {
    ...
    var matrix = new J3DIMatrix4();
    var _ = matrix.$matrix;
    _.m11=x0;     _.m12=y0;     _.m13=z0;     _.m14=0;
    _.m21=x1;     _.m22=y1;     _.m23=z1;     _.m24=0;
    _.m31=x2;     _.m32=y2;     _.m33=z2;     _.m34=0;
    _.m41=0;      _.m42=0;      _.m43=0;      _.m44=1;
